...
var mbtiResult = {
  "ISTJ": {
    ...
    "character": "문제를 해결하는데 과거의 경험을 잘 적용하는 '",
  ...
  "ISTP": {
    ...
    "character": "필요 이상으로 자신을 발휘하지 않으며 합리적으로 인생을 관찰하는 '",
  ...
  "ISFJ": {
    ...
    "character": "과거 회상을 좋아하며, 남들이 기억하기 힘든 세세한 추억까지 간직하는 '",
    "backgroundImage": "url(./img/result_bg_green.jpg)",
    "gemStoneFrame": "url(./img/result_frame_green.png)",
  ...
  "ISFP": {
    ...
    "character": "미루고 미뤄 오랜 기간이 걸리더라도 끝내 예술의 꽃을 피워내는 '",
    "backgroundImage": "url(./img/result_bg_green.jpg)",
    "gemStoneFrame": "url(./img/result_frame_green.png)",
  ...
  "INTJ": {
    ...
    "character": "끊임없이 지식을 탐구하고 '평범'보다는 '비범'이라는 말이 어울리는 '",
  ...
  "INTP": {
    ...
    "character": "얼핏 게을러 보일 수 있지만, 끝없이 노력해 최고의 자리에 오를 수 있는 '",
  ...
  "INFJ": {
    ...
    "character": "뛰어난 직관과 통찰력으로 타인에게 강한 영감을 주는 '",
  ...
  "INFP": {
    ...
    "character": "어떤 사람들과도 조화롭게 어울릴 수 있고, 평화를 추구하는 '",
    "backgroundImage": "url(./img/result_bg_pink.jpg)",
    "gemStoneFrame": "url(./img/result_frame_pink.png)",
  ...
  "ESTJ": {
    ...
    "character": "주변 상황을 잘 판단하여 무엇이 옳고 그른지 따져 주변을 하나로 결집시키는 '",
    "backgroundImage": "url(./img/result_bg_blue.jpg)",
  ...
  "ESTP": {
    ...
    "character": "관대하고 느긋하며 선입견없이 개방적인 '",
    "backgroundImage": "url(./img/result_bg_blue.jpg)",
    "gemStoneFrame": "url(./img/result_frame_blue.png)",
  ...
  "ESFJ": {
    ...
    "character": "동정심이 많고 사회성이 풍부해 다른 사람과 잘 어울리는 '",
  ...
  "ESFP": {
    ...
    "character": "사교적이고 활동적이며 어느 모임에서도 밝은 분위기를 만드는 '",
    "backgroundImage": "url(./img/result_bg_orange.jpg)",
    "gemStoneFrame": "url(./img/result_frame_orange.png)",
  ...
  "ENTJ": {
    ...
    "character": "열정이 넘치고 항상 체계적으로 행동해 사회적으로도 가장 성공하는 성격의 '",
    "backgroundImage": "url(./img/result_bg_purple.jpg)",
    "gemStoneFrame": "url(./img/result_frame_purple.png)",
  ...
  "ENFJ": {
    ...
    "character": "온화하고 적극적이며 사교성이 풍부하고 동정심이 많은 '",
    "backgroundImage": "url(./img/result_bg_pink.jpg)",
    "gemStoneFrame": "url(./img/result_frame_pink.png)",
  ...
  "ENFP": {
    ...
    "character": "열정이 넘치고 상상력이 풍부해 항상 분위기메이커가 되는 '",
    "backgroundImage": "url(./img/result_bg_pink.jpg)",
    "gemStoneFrame": "url(./img/result_frame_pink.png)",
