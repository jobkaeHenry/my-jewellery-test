...
var mbtiResult = {
  "ISTJ": {
    ...
    "character": "문제를 해결하는데 과거의 경험을 잘 적용하는' " + userName + "' 님과 꼭 맞는 보석이네요!",
  ...
  "ISTP": {
    ...
    "character": "필요 이상으로 자신을 발휘하지 않으며 합리적으로 인생을 관찰하는' " + userName + "' 님과 꼭 맞는 보석이네요!",
  ...
  "INTP": {
    ...
    "character": "얼핏 게을러 보일 수 있지만, 끝없이 노력해 최고의 자리에 오를 수 있는' " + userName + "' 님과 잘 어울리는 보석이네요",
  ...
  "INFJ": {
    ...
    "character": "뛰어난 직관과 통찰력으로 타인에게 강한 영감을 주는' " + userName + "' 님과 정말 잘 어울리는 보석이에요",
  ...
  "INFP": {
    ...
    "character": "어떤 사람들과도 조화롭게 어울릴 수 있고, 평화를 추구하는' " + userName + "' 님과 정말 어울리는 보석이네요",
    "backgroundImage": "url(./img/result_bg_pink.jpg)",
    "gemStoneFrame": "url(./img/result_frame_pink.png)",
  ...
  "ESTJ": {
    ...
    "character": "주변 상황을 잘 판단하여 무엇이 옳고 그른지 따져 주변을 하나로 결집시키는' " + userName + "' 님과 어울리는 보석이네요",
    "backgroundImage": "url(./img/result_bg_blue.jpg)",
  ...
  "ESTP": {
    ...
    "character": "관대하고 느긋하며 선입견없이 개방적인' " + userName + "' 님의 바다같은 성격과 정말 잘 어울리는 보석이네요!",
    "backgroundImage": "url(./img/result_bg_blue.jpg)",
    "gemStoneFrame": "url(./img/result_frame_blue.png)",
  ...
  "ESFJ": {
    "subtitle": "상큼한 레몬빛의,",
    "title": "시트린",
    "subscription": "이름만 들어도 상큼한 노란빛의 '시트린'은, 수정 종류에서 가장 비싼 보석이고, 가장 인기있는 수정이에요",
    "character": "동정심이 많고 사회성이 풍부해 다른 사람과 잘 어울리는' " + userName + "' 님과 정말 잘 어울리는 보석이네요",
  ...
  "ESFP": {
    ...
    "character": "사교적이고 활동적이며 어느 모임에서도 밝은 분위기를 만드는' " + userName + "' 님을 닮은 아름다운 보석이네요!",
    "backgroundImage": "url(./img/result_bg_orange.jpg)",
    "gemStoneFrame": "url(./img/result_frame_orange.png)",
  ...
  "ENTJ": {
    ...
    "character": "열정이 넘치고 항상 체계적으로 행동해 사회적으로도 가장 성공하는 성격의' " + userName + "' 님과 정말 잘 어울리는 보석이에요",
    "backgroundImage": "url(./img/result_bg_purple.jpg)",
    "gemStoneFrame": "url(./img/result_frame_purple.png)",
  ...
  "ENTP": {
    ...
    "title": "알렉산드라이트",
    "subscription": "'알렉산드라이트'는 태양빛 아래에서는 에메랄드, 밤의 촛불 아래에서는 루비로 변하는 신비한 보석이에요",
    "character": "즉흥적이고 유연하며, 순발력이 뛰어난 '" + userName + "' 님과 정말 잘 어울리는 보석이네요!",
    "backgroundImage": "url(./img/result_bg_purple.jpg)",
    "gemStoneFrame": "url(./img/result_frame_purple.png)",
  ...
  "ENFJ": {
    ...
    "character": "온화하고 적극적이며 사교성이 풍부하고 동정심이 많은' " + userName + "' 님과 너무 잘 어울리는 보석이네요!",
    "backgroundImage": "url(./img/result_bg_pink.jpg)",
    "gemStoneFrame": "url(./img/result_frame_pink.png)",
  ...
  "ENFP": {
    ...
    "character": "열정이 넘치고 상상력이 풍부해 항상 분위기메이커가 되는' " + userName + "' 님과 정말 어울리는 보석이지 않나요?",
    "backgroundImage": "url(./img/result_bg_pink.jpg)",
    "gemStoneFrame": "url(./img/result_frame_pink.png)",
